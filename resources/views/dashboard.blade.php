                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" style="font-size: 18px">
                                ...
                                <br>
                                <label for="kodeBarang"><b>Nama Barang</b></label>
                                <input type="text" name="kodeBarang" id="kodeBarang" placeholder="Nama Barang" class="form-control">
                                <br>
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="kodeBarang"><b>Stok Minimal</b></label>
                                        <input type="text" name="kodeBarang" id="kodeBarang" placeholder="Stok Minimal" class="form-control">
                                        <br>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="kodeBarang"><b>Stok Awal</b></label>
                                        <input type="text" name="kodeBarang" id="kodeBarang" placeholder="Stok Awal" class="form-control">
                                        <br>
                                    </div>
                                </div>
                            </form>
                        ...
                        <button type="button" class="btn btn-danger" onclick="buat()">Simpan</button>
                        </div>
                    </div>
                    </div>
                </div>
